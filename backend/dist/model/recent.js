...
exports.register = exports.findById = exports.findAll = exports.Recents = void 0;
...
var recentSchema = new _mongodb.default.Schema({
  id: String,
  volumeInfo: Object
}, {
  timestamps: true,
...
var Recents = _mongodb.default.model("recents", recentSchema);
